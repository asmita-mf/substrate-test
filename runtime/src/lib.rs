...
pub use frame_support::{
	...
	traits::{
		...
		EnsureOneOf, EqualPrivilegeOnly, OnFinalize, OnInitialize,
	},
	weights::{
...
impl pallet_scheduler::Config for Runtime {
	...
	type ScheduleOrigin = EnsureSigned<AccountId>; //, EnsureSignedBy<One, u64>>;
...
parameter_types! {
	pub const GracePeriod: u32 = 60;
}

impl pallet_usd_rate::Config for Runtime {
	type AuthorityId = pallet_usd_rate::crypto::usd_rate_pallet_crypto::OffchainAuthId;
	type Event = Event;
	type Call = Call;
	type GracePeriod = GracePeriod;
	type WeightInfo = pallet_usd_rate::weights::WeightInfoStruct<Runtime>;
}
